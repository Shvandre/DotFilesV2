...
var ASM_CONSTS = {
  310148: ($0, $1, $2, $3) => { return setTimeout( () => window.inkWasmRegistry[$3].dynCall_vi($1, $2), $0); },  
 310229: ($0) => { clearTimeout($0); },  
 310251: ($0, $1) => { window.inkHostRegistry[$1].setTargetFPS($0); },  
 310300: ($0) => { window.inkHostRegistry[$0].bindScreen(); },  
 310345: ($0, $1) => { window.inkHostRegistry[$1].requestImage(UTF8ToString($0)); },  
 310408: ($0, $1, $2, $3) => { window.inkHostRegistry[$3].setCursor($0, $1, $2); },  
 310462: ($0, $1, $2) => { window.inkHostRegistry[$2].navigateToUri(UTF8ToString($0, $1)); },  
 310530: ($0, $1) => { window.inkHostRegistry[$1].setKeyboardMode($0); },  
 310582: ($0, $1, $2) => { window.inkHostRegistry[$2].onAccessibilityData( new Uint8Array(HEAPU8.subarray($0, $0 + $1))); },  
 310681: ($0) => { return window.inkHostRegistry[$0].shouldPreloadShaders(); },  
 310743: ($0) => { return window.inkHostRegistry[$0].shouldRegisterDocument(); },  
 310807: ($0, $1, $2, $3, $4, $5) => { const buf = window.inkHostRegistry[$5].renderText( HEAPU8.subarray($0, $0 + $1), $2, $3); HEAP8.set(buf, $4); },  
 310921: ($0, $1, $2, $3, $4, $5) => { const name = window.inkHostRegistry[$0].selectMatchingFont( UTF8ToString($1, $2), $3, !!$4, $5); if (name) { const size = lengthBytesUTF8(name) + 1; const tempBuffer = _malloc(size); stringToUTF8(name, tempBuffer, size); return tempBuffer; } return 0; },  
 311177: ($0, $1, $2) => { window.inkHostRegistry[$2].onSceneChange( new Uint8Array(HEAPU8.subarray($0, $0 + $1))); },  
 311270: ($0, $1, $2, $3, $4, $5, $6, $7, $8) => { window.inkHostRegistry[$8].onImageExported( $0, $1, $2, new Uint8ClampedArray(HEAPU8.subarray($3, $3 + $4)), $5, $6, UTF8ToString($7)); },  
 311410: ($0, $1, $2) => { window.inkHostRegistry[$2].onToolEvent( new Uint8Array(HEAPU8.subarray($0, $0 + $1))); },  
 311501: ($0, $1) => { window.inkHostRegistry[$1].onSequencePointReached($0); },  
 311560: ($0, $1, $2) => { window.inkHostRegistry[$2].onFlagChanged($0, !!$1); },  
 311616: ($0) => { window.inkHostRegistry[$0].onCameraChanged(); },  
 311666: ($0, $1) => { window.inkHostRegistry[$1].onCameraMovementStateChanged(!!$0); },  
 311733: ($0, $1) => { window.inkHostRegistry[$1].onBlockingStateChanged(!!$0); },  
 311794: ($0) => { window.inkHostRegistry[$0].onInvisibleLayerActionPrevented(); },  
 311860: ($0, $1, $2) => { window.inkHostRegistry[$2].onPdfLoadSuccess( new Uint8Array(HEAPU8.subarray($0, $0 + $1))); },  
 311956: ($0) => { window.inkHostRegistry[$0].onPdfLoadPasswordRequired(); },  
 312016: ($0, $1, $2) => { window.inkHostRegistry[$2].onPdfLoadFailure(UTF8ToString($0, $1)); },  
 312087: ($0, $1, $2, $3) => { window.inkHostRegistry[$3].onPdfSaveSuccess( $0, new Uint8Array(HEAPU8.subarray($1, $1 + $2))); },  
 312187: ($0, $1, $2, $3) => { window.inkHostRegistry[$3].onPdfSaveFailure($0, UTF8ToString($1, $2)); },  
 312262: ($0, $1) => { window.inkHostRegistry[$0].onPdfUnsupportedFeature($1); },  
 312322: ($0) => { window.inkHostRegistry[$0].onPdfFormChanged(); },  
 312373: ($0, $1, $2, $3, $4, $5, $6, $7) => { window.inkHostRegistry[$0].onPdfFormFieldFocused( $1, new Uint8Array(HEAPU8.subarray($2, $2 + $3)), $4, !!$5, UTF8ToString($6, $7)); },  
 312510: ($0, $1, $2) => { window.inkHostRegistry[$2].onPdfFormTextFieldFocusChanged( true, UTF8ToString($0, $1)); },  
 312602: ($0) => { window.inkHostRegistry[$0].onPdfFormTextFieldFocusChanged(false); },  
 312672: ($0, $1) => { window.inkHostRegistry[$1].onPendingTexturesChanged(!!$0); },  
 312735: ($0, $1, $2) => { const canvas = self.WorkerGlobalScope ? new OffscreenCanvas(128, 128) : document.createElement('canvas'); const gl = canvas.getContext('webgl'); if (gl) { const di = gl.getExtension('WEBGL_debug_renderer_info'); if (di) { stringToUTF8(gl.getParameter(di.UNMASKED_RENDERER_WEBGL), $0, $2); stringToUTF8(gl.getParameter(di.UNMASKED_VENDOR_WEBGL), $1, $2); } } },  
 313097: () => { return !!GLctx },  
 313114: () => { debugger },  
 313127: () => { return (typeof wasmOffsetConverter !== 'undefined'); }
};
function em_severity_log(severity,severityName,message) { if (typeof globalThis === 'object' && typeof globalThis['Module'] === 'object' && typeof globalThis['Module']['log'] === 'function') { globalThis['Module']['log']( severity, UTF8ToString(severityName), UTF8ToString(message)); } else { var loggers = [console.log, console.warn, console.error]; loggers[severity].call(console, UTF8ToString(severityName) + ' ' + UTF8ToString(message) + '\n'); } }
...
var _shouldOnlyDrawLineToolUpdate = Module['_shouldOnlyDrawLineToolUpdate'] = wasmExports['shouldOnlyDrawLineToolUpdate']
var _draw = Module['_draw'] = wasmExports['draw']
...
var dynCall_iiidd = Module['dynCall_iiidd'] = wasmExports['dynCall_iiidd']
var dynCall_iidd = Module['dynCall_iidd'] = wasmExports['dynCall_iidd']
...
var dynCall_iiiifi = Module['dynCall_iiiifi'] = wasmExports['dynCall_iiiifi']
var dynCall_iiiiifi = Module['dynCall_iiiiifi'] = wasmExports['dynCall_iiiiifi']
var dynCall_iiff = Module['dynCall_iiff'] = wasmExports['dynCall_iiff']
var dynCall_iiiff = Module['dynCall_iiiff'] = wasmExports['dynCall_iiiff']
...
var dynCall_viid = Module['dynCall_viid'] = wasmExports['dynCall_viid']
var dynCall_di = Module['dynCall_di'] = wasmExports['dynCall_di']
...
var dynCall_dii = Module['dynCall_dii'] = wasmExports['dynCall_dii']
...
var dynCall_iidi = Module['dynCall_iidi'] = wasmExports['dynCall_iidi']
var dynCall_viiif = Module['dynCall_viiif'] = wasmExports['dynCall_viiif']
var dynCall_viiiif = Module['dynCall_viiiif'] = wasmExports['dynCall_viiiif']
var dynCall_viiiiiiii = Module['dynCall_viiiiiiii'] = wasmExports['dynCall_viiiiiiii']
var dynCall_iiiijij = Module['dynCall_iiiijij'] = wasmExports['dynCall_iiiijij']
var dynCall_viidi = Module['dynCall_viidi'] = wasmExports['dynCall_viidi']
var dynCall_viifi = Module['dynCall_viifi'] = wasmExports['dynCall_viifi']
var dynCall_viiifi = Module['dynCall_viiifi'] = wasmExports['dynCall_viiifi']
var dynCall_viiid = Module['dynCall_viiid'] = wasmExports['dynCall_viiid']
var dynCall_fiiif = Module['dynCall_fiiif'] = wasmExports['dynCall_fiiif']
var dynCall_viidiff = Module['dynCall_viidiff'] = wasmExports['dynCall_viidiff']
var dynCall_iiidi = Module['dynCall_iiidi'] = wasmExports['dynCall_iiidi']
var dynCall_vidi = Module['dynCall_vidi'] = wasmExports['dynCall_vidi']
var dynCall_vidii = Module['dynCall_vidii'] = wasmExports['dynCall_vidii']
var dynCall_vifidi = Module['dynCall_vifidi'] = wasmExports['dynCall_vifidi']
var dynCall_viiiiiii = Module['dynCall_viiiiiii'] = wasmExports['dynCall_viiiiiii']
var dynCall_fif = Module['dynCall_fif'] = wasmExports['dynCall_fif']
var dynCall_viidii = Module['dynCall_viidii'] = wasmExports['dynCall_viidii']
...
var dynCall_viiiff = Module['dynCall_viiiff'] = wasmExports['dynCall_viiiff']
var dynCall_iiiiid = Module['dynCall_iiiiid'] = wasmExports['dynCall_iiiiid']
var dynCall_iiiid = Module['dynCall_iiiid'] = wasmExports['dynCall_iiiid']
...
var dynCall_viijii = Module['dynCall_viijii'] = wasmExports['dynCall_viijii']
var dynCall_vij = Module['dynCall_vij'] = wasmExports['dynCall_vij']
var dynCall_vijjj = Module['dynCall_vijjj'] = wasmExports['dynCall_vijjj']
var dynCall_vj = Module['dynCall_vj'] = wasmExports['dynCall_vj']
var dynCall_viij = Module['dynCall_viij'] = wasmExports['dynCall_viij']
var dynCall_viiiiij = Module['dynCall_viiiiij'] = wasmExports['dynCall_viiiiij']
var dynCall_iijjiiii = Module['dynCall_iijjiiii'] = wasmExports['dynCall_iijjiiii']
...
var dynCall_iiiiij = Module['dynCall_iiiiij'] = wasmExports['dynCall_iiiiij']
var dynCall_iiiiijj = Module['dynCall_iiiiijj'] = wasmExports['dynCall_iiiiijj']
var dynCall_iiiiiijj = Module['dynCall_iiiiiijj'] = wasmExports['dynCall_iiiiiijj']
